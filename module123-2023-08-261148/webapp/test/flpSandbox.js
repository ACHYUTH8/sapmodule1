		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TestApp",
									"targetURL": "#comappmodule123-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappmodule123-display": {
								"semanticObject": "comappmodule123",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.module123",
									"url": sap.ui.require.toUrl("com/app/module123")
								}
							}
						}
					}
